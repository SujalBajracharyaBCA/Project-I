...
<body class="bg-dark text-light">
    ...
    <div class="topnav">
        ...
        <a href="OLMS_my_library_v1.php"><i class="fa fa-align-justify fa-2x"></i>My Libraries</a>
            ...
            <a class="active" href="OLMS_my_tag_v1.php"><i class="fa fa-tag fa-2x"></i>My Tags</a>
        <?php if ($username) : ?>
            <div class="dropdown">
                ...
                <?php $sno=1;
                 foreach ($tags as $tag): ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_tag_v1.php?tag_id=<?php echo $tag["tag_id"]; ?>"><i class="fa fa-edit fa-2x"></i></a>
                            <a href="delete_tag_v1.php?tag_id=<?php echo $tag["tag_id"]; ?>" onclick="return confirm('Are you sure you want to delete this tag?')"><i class="fa fa-trash fa-2x"></i></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
