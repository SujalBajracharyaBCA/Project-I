...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $bname=$_POST['bname'];  
    $numofchaprd=$_POST['numofchaprd'];
     $numofchaptl=$_POST['numofchaptl'];
...
<div class="container">
    ...
    <div class="container">
        ...
        <textarea class="form-control" placeholder="Enter synopsis" id="synopsis" name="synopsis" cols="80" rows="20"></textarea>
           <br>
    </div><br>
    <div class="container">
        <label for="name" class="form-label"><p>URL:</p></label>
        <input type="textbox" class="form-control" placeholder="Enter URL" id="url" name="url" value="" required>
           <br>
    </div><br>
